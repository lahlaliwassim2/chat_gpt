...
function App() {
  ...
  return (
    ...
    <div className="bg-[#131d28bd] h-screen py-6 relative sm:px-16 px-12 text-white overflow-hidden flex flex-col justify-between  align-middle">
      {/* gradients */}
      ...
      "
      >
        <ChatBody chat={chat} loading={mutation.isLoading}/>
      </div>
